...
<!-- Page Title/Header End -->
 ...
 <div class="container">
    <div class="row">
      <div class="col-lg-9 col-md-8 listing_grid_item" style="margin-top: 100px;margin-bottom:100px">
        <div class="row">
            @foreach ($subpost as $subposts)
          <div class="col-lg-4 col-md-12" style="margin-bottom:100px"> <a href="single/{{$subposts->id}}" class="utf_listing_item-container" data-marker-id="1">
			...
			<div class="utf_star_rating_section" data-rating="4.5" style="height: 55px;text-align:center;background-color:#F2E1E3">
      ...
      <!-- Sidebar -->
      <div class="col-lg-3 col-md-4"  style="margin-top: 67px;margin-bottom:100px">
        <div class="sidebar">
